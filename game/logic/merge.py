...
class Merge(BaseLogic):
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        if (current_position==base and (board_bot.properties.milliseconds_left/1000)<= 1):
            ...
            print(board_bot.properties.milliseconds_left/1000," s")
            print(countMoves(current_position, base)," step") 
            # Analyze new state
