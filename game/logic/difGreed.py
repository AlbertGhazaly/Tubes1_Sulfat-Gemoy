...
class DifGreed(BaseLogic):
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        # Analyze new state
        if props.diamonds == 5 or (board_bot.properties.milliseconds_left/1000 + 3<= countMoves(current_position, base) 
                                    and board_bot.properties.milliseconds_left/1000 + 3<= countMoves(teleport_enter,current_position) + countMoves(teleport_exit,base)):
